...
class DashboardAdapter(val context: Context, private val subjects: DashboardData) :
    RecyclerView.Adapter<DashboardAdapter.ClassViewHolder>() {
    ...
    class ClassViewHolder(view: View, listener: OnnItemClickListener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ClassViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.home_card_view, parent, false)
